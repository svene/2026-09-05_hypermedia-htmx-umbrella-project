...
- [ ] **WP22 — Rename all `ssfe-*` and `hda-*` repos to `hypermedia-*`**
  ...
  | `2026-09-03_hda-springboot-browser-hono` | `2026-09-03_hypermedia-springboot-browser-hono` | ☑ **done 2026-09-12** — repo renamed, remote/folder/internals (pom.xml, playwright jar path, `HDA` terminology in architecture.md/readme.md) updated (`mvn compile` verified), no cross-repo refs found, umbrella docs swept; awaiting commits |
