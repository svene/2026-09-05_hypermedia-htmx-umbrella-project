...
The commit each sibling project was at **when the docs in this folder were
written**. When a project gains new commits later, diff from the hash recorded
here to see what the umbrella docs still need to catch up on.

- Analysis date: **2026-09-05**
- All projects analysed on branch `main` unless noted.

| Project (folder) | Branch | Commit at analysis | Date | Subject |
|---|---|---|---|---|
| `../../2025/2025-08-23_ssfe-patterns-jte-htmx` | main | `9d03e03` | 2025-08-24 | documented Template-Injection pattern and Template-Inclusion pattern |
| `../../2025/2025-08-23_ssfe-patterns-jte-vc-htmx` | main | `6dc16fb` | 2026-05-10 | s05: extracted the documentation |
| `../../2025/2025-08-23_ssfe-patterns-thymeleaf-htmx` | main | `07b4d91` | 2025-08-23 | springboot code: controller working |
| `../../2025/2025-12-21_ssfe-patterns-quarkus-qute-htmx` | main | `afab795` | 2026-01-15 | code for M05 |
| `../../2025/2025-12-27_ssfe-patterns-hono-htmx` | main | `ed939ef` | 2026-05-30 | moved tnt.md to docs project |
| `../../2025/2025-12-31-springboot-hono-poc` | main | `8016781` | 2026-08-30 | upgrade alpinejs |
...
```sh
# from this umbrella project root
git -C <project-folder> log --oneline <recorded-hash>..HEAD
```
...
To re-capture every hash at once:

```sh
for d in <project-folders>; do
  printf '%s\t' "$(basename "$d")"
